                                        ...
                                        <tr>
                                            <td style="width:250px;">
                                                <a href="{{ url('/') }}" target="_blank">
                                                    <img alt="Wellmedic" height="auto" src="{{ url('img/logo-newsletter.png') }}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"/>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-right:0px;padding-left:0px;word-break:break-word;">
                                    <div style="font-family:Roboto;font-size:14px;line-height:1.5;text-align:left;color:#000000;">
                                        <ul class="nav">
                                            <li class="nav_item"><a class="nav_link" href="{{ url('proizvodi') }}">proizvodi</a></li>
                                            <li class="nav_item"><a class="nav_link" href="{{ url('blog') }}">blog</a></li>
                                            <li class="nav_item"><a class="nav_link" href="{{ url('iskustva') }}">iskustva</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
    ...
    @if(count($templates)>0)
        ...
        @foreach($templates as $template)
            ...
            @if($template->type == 'post')
                ...
                @include('themes.wellmedic.emails.partials.leading-post')

            @elseif($template->type == 'posts')

                @php $post1 = \App\Post::find($template->item1); @endphp
                @php $post2 = \App\Post::find($template->item2); @endphp
                @include('themes.wellmedic.emails.partials.posts')

            @elseif($template->type == 'banner')

                @php $banner = \App\Banner::find($template->item1); @endphp
                @include('themes.wellmedic.emails.partials.banner')

            @else

                @php $testimonial = \App\Testimonial::find($template->item1); @endphp
                @include('themes.wellmedic.emails.partials.testimonial')
